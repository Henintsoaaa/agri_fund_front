...
export default function ModernProjectStageCard({
  stage,
  onInvest,
  onViewDetails,
  ...
  return (
    <Card className="bg-cream border-sage/30 hover:shadow-lg transition-all duration-300 overflow-hidden group">
      {/* Image */}
